...
import {ETCswapImmutables, ETCswapParameters} from './modules/etcswap/ETCswapImmutables.sol';
...
contract UniversalRouter is IUniversalRouter, Dispatcher, RewardsCollector {
    ...
    constructor(RouterParameters memory params)
        ETCswapImmutables(
            ETCswapParameters(params.v2Factory, params.v3Factory, params.pairInitCodeHash, params.poolInitCodeHash)
        )
