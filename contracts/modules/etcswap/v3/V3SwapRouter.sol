...
import {SafeCast} from '@etcswap/v3-core/contracts/libraries/SafeCast.sol';
import {IETCswapV3Pool} from '@etcswap/v3-core/contracts/interfaces/IETCswapV3Pool.sol';
import {IETCswapV3SwapCallback} from '@etcswap/v3-core/contracts/interfaces/callback/IETCswapV3SwapCallback.sol';
...
/// @title Router for ETCswap v3 Trades
abstract contract V3SwapRouter is ETCswapImmutables, Permit2Payments, IETCswapV3SwapCallback {
    ...
    /// @notice Performs a ETCswap v3 exact input swap
    ...
    /// @notice Performs a ETCswap v3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IETCswapV3Pool(computePoolAddress(tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            ETCSWAP_V3_POOL_INIT_CODE_HASH
                        )
                    )
                )
            )
